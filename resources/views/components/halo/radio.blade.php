...
$dotClasses = halo_merge_classes(
    'w-4 h-4 rounded-full border-halo-border accent-halo-primary transition-colors hover:border-halo-foreground/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-halo-ring disabled:opacity-50 disabled:cursor-not-allowed',
